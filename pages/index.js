      ...
      <div>
        <div className="hero">
          <div className="left-hero">
            ...
            <Image
              src={'/../public/assets/HomepageImages/hero-landscape.jpg'}
              width={800}
              height={470}
        ...
        <div className="features-background">
          <div className="features">
            <div className="top-features">
              <h2>Vi tilbyr</h2>
              <p>
                Vi tilbyr et bredt utvalg av vinduer og dører som passer for
          ...
          <div className="mini-hero-main">
            ...
            <div className="right-mini-hero">
              ...
              <p>
                ...
                skreddersy løsninger tilpasset deg, og dine prosjekters behov.
                Vi tilbyr et bredt utvalg av vinduer og dører som passer for
                alle og enhver.
              </p>
            </div>
