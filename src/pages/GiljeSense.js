  ...
  return (
    <div className='gilje-sense__container'>
      ...
      <div className="gilje-sense__container-hero">
        ...
        Gilje Sense gir deg en indre rohet om at hjemmet ditt er trygt når du er på butikken, jobb eller på reise. <br /> <br />
        Kontakt oss for mer utfyllende informasjon.</p>
        
        </div>
        <div className="gilje-sense__container__right-hero"><iframe title="vimeo-player" src="https://player.vimeo.com/video/238541686?h=feab716ecf" width="640" height="360" frameborder="0"    allowfullscreen></iframe></div>
      </div>
    </div>
  )
}
